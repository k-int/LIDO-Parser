...
import ro.webdata.lido.parser.core.leaf.genericDate.GenericDate;
 ...
 * 		<div class="lido-doc">
 * 			<b>Definition:</b> A year or exact date that broadly delimits the beginning of an
 * 			implied date span.<br/>
 ...
 *
 */
public class EarliestDate extends GenericDate {
	public EarliestDate() {}

	public EarliestDate(GenericDate date) {
		super(
			date.getText(),
			date.getType(),
			date.getSource(),
